...
const RepositoryHeader = ({
  ...
  const [AllSuites, setAllSuites] = useState<GetSuitesByProjectIdResponseType>({ suites: [] });
  ...
  return (
    <div className="repository-header">
      <AddSuiteModal isModalOpen={isModalOpen} setModalOpen={setModalOpen} suites={AllSuites}/>
